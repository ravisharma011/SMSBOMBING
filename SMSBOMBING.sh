...
banner() {
    ...
    echo -e "\e[1;32m           Instagram: www.instagram.com/aboyof20 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of SMSBOMBING for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Ravi Sharma > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN SMSBOMBING Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
